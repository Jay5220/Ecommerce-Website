        ...
        load = async(e, fragments, cart_hash, $button) => {
                ...
                loadVariantions = async () => {
                    ...
                    if (forms[0] || doc.tfClass('wcpa_form_outer').length > 0) {
                        ...
                        await Promise.all([Themify.loadJs(Themify.includesURL + 'js/wp-util.min', (win.wp !== und && und !== win.wp.template), fwVars.wp),Themify.loadJs(variantionURL, ('undefined' !== typeof $.fn.wc_variation_form), v)]);
