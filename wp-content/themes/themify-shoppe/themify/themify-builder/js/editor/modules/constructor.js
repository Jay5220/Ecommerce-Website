    ...
    ThemifyConstructor = {
        ...
        lottie:{
                ...
                return {
                    ...
                    options:[
                        ...
                        },
                        {
                            ...
                            comment: "After X click(s) this animtion will start play."
                        },
                        {
                            type: "message",
                            label: "",
                            wrap_class: "tb_hover_msg",
                            comment: "After X hover(s) this animtion will start play."
                        },
                        {
                            type: "message",
                            label: "",
                            wrap_class: "tb_loop_msg",
                            comment: "Type repeat(s)."
                        },
                        {
                            type: "message",
                            label: "",
                            wrap_class: "tb_hold_msg",
                            comment: "Hover will start animation. If the user releases the hover over the animation it plays in reverse."
                        },
                        {
                            type: "message",
                            label: "",
                            wrap_class: "tb_pausehold_msg",
                            comment: "Hover will start animation. If the user releases the hover over the animation it pauses."
                        },
                        {
                            type: "group",
                            ...
                            options: [
                                {
                                    ...
                                    type: "slider_range",
                                    label: "Visibility",
                                    help: "When this element will be in the range ",
                                    options: {
                                        unit: "%"
                                    }
                                },
                        ...
                        },
                        {
                            ...
                            options: [
                                ...
                                },
                                {
                                    ...
                                    comment: "After X click(s) will switch to next animation."
                                },
                                {
                                    type: "message",
                                    label: "",
                                    wrap_class: "tb_nhover_msg",
                                    comment: "After X hover(s) will switch to next animation."
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            help: "Type frame id to use only that frame in json",
                            options: frames,
                            control:false
                        },
                        {
                            ...
                            label: "Play Segment",
                            help: "Enter frame from-to,will be played only that segment",
                            options: {
                                min:min,
                                max: max,
                                unit: ""
            ...
            render(data, self) {
                ...
                browse.tfOn(Themify.click,async e=>{
                    ...
                    await TF_LottieBrowse.run(input);
        ...
        checkboxGenerate(type, data) {
            ...
            for (let i = 0; i < len; ++i) {
                ...
                ch.checked = (v !== und && v !== false && v.indexOf(options[i].name) !== -1) || (_default === options[i].name || (is_array === true && _default.indexOf(options[i].name) !== -1));
                if (data.class !== und) {
