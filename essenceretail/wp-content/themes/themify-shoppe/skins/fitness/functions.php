<?php
/**
 * Custom functions specific to the Fitness skin
 *
 * @package Themify Shoppe
 */

/**
 * Load Google web fonts required for the Fitness skin
 *
 * @since 1.4.9
 * @return array
 */
...
add_filter( 'themify_google_fonts', 'themify_theme_fitness_google_fonts' );