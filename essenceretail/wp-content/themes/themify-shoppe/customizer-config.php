...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'form_fields_focus_background' => array(
			...
			'selector' => 'select:focus,textarea:focus,input:read-write:focus,input:read-only:focus',
			'prop' => 'background',
		),
		...
		'form_buttons_background' => array(
			...
			'selector' => 'input[type=reset], input[type=submit], button, .woocommerce #respond input#submit',
			'prop' => 'background',
		),
		...
		'form_buttons_hover_background' => array(
			...
			'selector' => 'input[type=reset]:hover, input[type=submit]:hover, button:hover, .woocommerce #respond input#submit:hover',
			'prop' => 'background',
		),
